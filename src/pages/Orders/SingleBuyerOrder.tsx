            ...
            <div className="flex items-center gap-x-3">
              ...
              {isEditable && (
                <form action="" className="flex gap-x-1 xmd:gap-x-3 " onSubmit={submitHandler}>
                  <div className="relative  border-[1px] border-neutral-300 rounded-xl text-[.9rem] w-[5.5rem] xmd:w-32">
                    <div
                      onClick={() => setShowMenu((prevValue) => !prevValue)}
                      className={`${isEditable ? 'cursor-pointer' : ' cursor-not-allowed'} gap-x-1 xmd:gap-x-4 pl-3 pr-1 xmd:px-4 py-[.36rem] rounded-xl flex items-center justify-between hover:bg-neutral-200 duration-300 active:bg-neutral-300`}
                    >
                      <input
                        type="text"
                        title={activeStatus}
                    ...
                    {showMenu && (
                      <div className=" animate-slideInFromTop absolute top-9 left-[-2px] bg-baseWhite xmd:w-40 px-1 py-1 shadow-xl border-[1px] border-neutral-200 rounded-lg text-neutral-800">
                        <ul>
                  ...
                  <button
                    type={submitFormLoading || activeStatus.toLowerCase() === 'order placed' ? 'button' : 'submit'}
                    className={`${activeStatus.toLowerCase() === 'order placed' ? 'cursor-not-allowed' : 'cursor-pointer hover:bg-neutral-800'} flex items-center justify-center border-[1px] border-neutral-300 rounded-xl px-3 xmd:px-5 py-1 text-xs xmd:text-[.9rem] bg-neutral-600 text-baseWhite w-20 xmd:w-32`}
                  >
